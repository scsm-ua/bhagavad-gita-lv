...
Tagad Es tev aprakstı̄šu izzin̦as objektu, kuru izprotot, tu malkosi nemirstı̄bas nektāru. Tās ir Manas mūžı̄gās garı̄gās izpausmes (Brahmans, Paramātma un  Bhagavāns)*, kuras dēvē par Absolūto Istenı̄bu. Zini, ka Absolūts ir atšk̦irı̄gs no visa eksistējošā, tomēr Tas nav neeksistējošs. Tas mı̄t ārpus materiālajiem cēlon̦iem un sekām.
